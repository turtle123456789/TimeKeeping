 ...
 * Cung cấp dropdown selection với styling nhất quán
 */
...
/**
 * Component nội dung của Select
 * @param {Object} props - Props của component
 * @param {string} props.className - Class CSS bổ sung
 * @param {string} props.position - Vị trí hiển thị (popper, item-aligned)
 */
...
/**
 * Component separator của Select
 * @param {Object} props - Props của component
 * @param {string} props.className - Class CSS bổ sung
 */
